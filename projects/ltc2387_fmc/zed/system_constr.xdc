...
set_property -dict {PACKAGE_PIN P17    IOSTANDARD LVDS_25} [get_ports da_p]                             ; ## H07  FMC_LPC_LA02_P
set_property -dict {PACKAGE_PIN P18    IOSTANDARD LVDS_25} [get_ports da_n]                             ; ## H08  FMC_LPC_LA02_N
set_property -dict {PACKAGE_PIN M21    IOSTANDARD LVDS_25} [get_ports db_p]                             ; ## H10  FMC_LPC_LA04_P
set_property -dict {PACKAGE_PIN M22    IOSTANDARD LVDS_25} [get_ports db_n]                             ; ## H11  FMC_LPC_LA04_N
...
# set_property -dict {PACKAGE_PIN L21    IOSTANDARD LVDS_25} [get_ports muxcntrl]                         ; ## C10  FMC_LPC_LA06_P
# set_property -dict {PACKAGE_PIN L22    IOSTANDARD LVDS_25} [get_ports mux_en]                           ; ## C11  FMC_LPC_LA06_N
