...
adi_ip_create axi_pwm_gen
    ...
    create_ip -name ila -vendor xilinx.com -library ip -version 6.2 -module_name pwm_ila
    set_property -dict [list CONFIG.C_MONITOR_TYPE {Native}] [get_ips pwm_ila]
    set_property -dict [list CONFIG.C_NUM_OF_PROBES {8}] [get_ips pwm_ila]
    set_property -dict [list CONFIG.C_DATA_DEPTH {4096}] [get_ips pwm_ila]
    set_property -dict [list CONFIG.C_TRIGIN_EN {false}] [get_ips pwm_ila]
    set_property -dict [list CONFIG.C_PROBE0_WIDTH {1}] [get_ips pwm_ila]
    set_property -dict [list CONFIG.C_PROBE1_WIDTH {1}] [get_ips pwm_ila]
    set_property -dict [list CONFIG.C_PROBE2_WIDTH {1}] [get_ips pwm_ila]
    set_property -dict [list CONFIG.C_PROBE3_WIDTH {1}] [get_ips pwm_ila]
    set_property -dict [list CONFIG.C_PROBE4_WIDTH {1}] [get_ips pwm_ila]
    set_property -dict [list CONFIG.C_PROBE5_WIDTH {1}] [get_ips pwm_ila]
    set_property -dict [list CONFIG.C_PROBE6_WIDTH {32}] [get_ips pwm_ila]
    set_property -dict [list CONFIG.C_PROBE7_WIDTH {32}] [get_ips pwm_ila]
    generate_target {all} [get_files axi_pwm_gen.srcs/sources_1/ip/pwm_ila/pwm_ila.xci]
